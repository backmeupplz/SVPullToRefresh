...
- (void)layoutSubviews {
    ...
    arrowFrame.origin.x = self.bounds.size.width/2 - 11;
...
- (SVPullToRefreshArrow *)arrow {
    if(!_arrow) {
		_arrow = [[SVPullToRefreshArrow alloc]initWithFrame:CGRectMake(self.bounds.size.width/2 - 11, self.bounds.size.height-54, 22, 48)];
